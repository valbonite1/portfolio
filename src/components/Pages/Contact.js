...
function Contact() {
    ...
    useEffect(() => {
        ...
        tl.from(formLoad, {opacity: 0, duration: 0.8, y:120, ease: Power3.easeout, delay: 0.2});
    ...
    emailjs.sendForm('service_t1qjsgw', 'contact_template', e.target, 'user_WlPTH9fHscVkiu8oS6O8k')
        .then((result) => {
